                ...
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number"  id="rol" name="rol" class="form-control" placeholder="Escribe el rol, 2 Profesor, 3 Alumno..">
                           ...
                           <br>
                               ...
                               name="registrar">
                               <a href="includes/login.php" class="btn btn-danger">Cancelar</a>
